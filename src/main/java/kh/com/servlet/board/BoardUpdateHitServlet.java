...
@WebServlet("/BoardUpdateHitServlet")
public class BoardUpdateHitServlet extends HttpServlet {
...
@SuppressWarnings("unchecked")
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String getGmb_hit = String.valueOf(jsonObj.get("gmb_hit"));
		int intGmb_hit = Integer.parseInt(getGmb_hit);
	
		BoardDAO dao = new BoardDAO();
		boolean rstComplete = dao.boardUpdateHit(intId, intGmb_hit);
